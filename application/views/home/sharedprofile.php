...
<section class="matchprofile">
  <div class="container">
    <div class="row">
      ...
      <input type="hidden" name = "shared_profile_uuid" id = "shared_profile_uuid"  value="<?php echo $Shared_by_details[0]['shared_profile_uuid'] ;?>">
      <div class="col-md-10">
...
<script>
  ...
  $(document).ready(function() {
	$('#view_details').click(function(){
		...
		var shared_profile_uuid = $('#shared_profile_uuid').val();
		$.ajax({
			type: "POST",
			url: "<?php echo base_url(); ?>Profile/view_hidden_details/"+uuid,
			data:{sharedId:shared_profile_uuid},
