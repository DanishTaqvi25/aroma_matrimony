                     ...
                     $.ajax({
                      ...
                      success: function(result) {
							$.each(JSON.parse(result), function(i, itemsingle) {
								...
								$('#password').val(itemsingle.profile_password);
					...
					$.ajax({
                      ...
                      success: function(result) {
							...
							$.each(JSON.parse(result), function(i, itemsingle) {
								...
								'<div class="tools-edit-image" style = "display:block !important"><a href="javascript:void(0)" data-no="' + num + '" class="btn btn-light btn-edit-image"><input data-validation = "required" type="radio" value = "'+num+'"  '+txt_main+' name="cover">Make this cover photo</a></div>' +
								'</div>';
