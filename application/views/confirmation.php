            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo $action; ?>/_payment" method="post" id="payuForm" name="payuForm">
                        ...
                        <input type="hidden" name="package_uuid" value="<?php echo $package_uuid; ?>" />
                        <input type="hidden" name="profile_uuid" value="<?php echo $profile_uuid; ?>" />
                        ...
                        <div class="form-group float-right">
                            <input type="submit" value="Pay Now" class="btn btn-success sub" />
                        </div>
                    </form>
                </div>
            </div>
